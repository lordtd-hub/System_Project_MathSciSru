...
const base = process.env.QA_PREVIEW_URL ?? "https://system-project-math-sci-8nu3416ka-lordtd-hubs-projects.vercel.app";
...
async function main() {
  ...
  console.log(JSON.stringify({ navigated: url }, null, 2));
  client.close();
}
