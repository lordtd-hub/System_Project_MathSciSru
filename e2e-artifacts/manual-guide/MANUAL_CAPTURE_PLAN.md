...
- ไม่ถ่ายหน้า `/qa-login` ลงคู่มือผู้ใช้งานจริง หน้า QA login เป็นเพียงทางเข้าภายในสำหรับสลับบทบาทระหว่างถ่ายคู่มือเท่านั้น
- ภาพคู่มือให้เริ่มหลังเข้าสู่ระบบแล้ว เช่น dashboard ของนักศึกษา dashboard ของอาจารย์ หรือ dashboard ของผู้ดูแลระบบ
