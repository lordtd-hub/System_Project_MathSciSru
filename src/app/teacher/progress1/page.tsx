...
import { progress1Criteria } from "@/lib/scoring/progress1Scoring";
        ...
        {projects.length ? projects.map((project) => {
          ...
          return (
            <section key={project.id} className="panel">
              ...
              <form action={submitProgress1Score} className="mt-4 grid gap-4 md:grid-cols-5">
                <input type="hidden" name="project_id" value={project.id} />
                {progress1Criteria.map((criterion) => (
                ...
                <div className="md:col-span-5">
                  <SubmitButton pendingText="กำลังบันทึกคะแนน..." confirmMessage="ยืนยันการบันทึกคะแนน Progress 1 หรือไม่?">
